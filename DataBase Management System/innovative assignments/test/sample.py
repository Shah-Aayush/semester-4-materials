...
#mycursor.execute("create table questions3(qno_no int(3) primary key , qno_desc varchar(100),opt_a varchar(500), opt_b varchar(500), opt_c varchar(500) ,opt_d varchar(500) , ans varchar(100))")
print("QUIZ SOFTWARE")
print("1.questions")
