...
#            count += 1
        ...
        for list_item in output:
                tv.insert(parent='', index="end", text="Parent", values=(str(list_item[0]), str(list_item[1]),str(list_item[2]),str(list_item[3]),str(list_item[4])))
    ...
    def select_modify(self):
        if (tv.focus() != ""):
            ...
            messagebox.showerror("showerror", "Please select a row to be modified")
...
class Exam:
    def __init__(self, top=None):
        ...
        for list_item in output:
                tv.insert(parent='', index="end", text="Parent", values=(str(list_item[0]), list_item[1], list_item[2], list_item[3], str(list_item[4]), str(list_item[5]), str(list_item[6]), list_item[7]))
    ...
    def select_delete(self):
        try:
            ...
            try:
                    ...
                    messagebox.showerror("showerror", str(e))  # displaying error
...
class Subject:
    def __init__(self, top=None):
        ...
        for list_item in output:
                tv.insert(parent='', index="end", text="Parent", values=(str(list_item[0]), str(list_item[1]), str(list_item[2]), str(list_item[3])))
...
#            Scrolledtext1.insert(1.0, myTable)  # showing output message
            ...
            i=0 
            random_string = ""
            for branch in output_message: 
                for j in range(len(branch)):
                    e = Entry(Scrolledtext1, width=10, fg='blue') 
                    e.grid(row=i, column=j) 
                    e.insert(END, branch[j])
#                    for i in range(15):
#                        random_string += "\t"
                    random_string += "\n"
            ...
            Scrolledtext1.insert(1.0, random_string)
...
class AttendanceAdd:
    def __init__(self, top=None):
        ...
        self.login_entry = tk.Entry(top, background="white", disabledforeground="#a3a3a3", font="TkFixedFont",
                                    foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                    insertbackground="black", selectbackground="blue", selectforeground="white", textvariable=time_format1)
        ...
        self.logout_entry = tk.Entry(top, background="white", disabledforeground="#a3a3a3", font="TkFixedFont",
                                     foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                     insertbackground="black", selectbackground="blue", selectforeground="white", textvariable=time_format2)
        ...
        self.add_button = tk.Button(top, activebackground="#ececec", activeforeground="#000000", background="#E9ECEF",
                                     disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#d9d9d9",
                                     highlightcolor="black", pady="0", text='''Add''', command=lambda:self.select_add(self.att_id_entry.get(), self.student_id_entry.get(), self.exam_id_entry.get(), self.login_entry.get(), self.logout_entry.get()))
    ...
    def select_add(self, attendance_id, student_id, exam_id, login_time, logout_time):
        if len(attendance_id)!=0 and len(student_id)!=0 and len(exam_id)!=0 and len(login_time)!=0 and len(logout_time)!=0:
            
            sql_query = "INSERT INTO attendance VALUES(" + str(attendance_id) + ", " + str(student_id) + ", " + str(exam_id) + ", TIME('" + login_time + "'), TIME('" + logout_time + "'));"
            try:
                mycursor.execute(sql_query)                                     #executing query
                tv.insert(parent='', index='end', text="Parent", values=(str(attendance_id), str(student_id), str(exam_id), login_time, logout_time))
                print("inside try : ",mycursor.fetchall())
            except (mysql.connector.Error, mysql.connector.Warning) as e:       #fetching error
                messagebox.showerror("showerror","ERROR MESSAGE :\n" + str(e)) 
                print("inside except : ",mycursor.fetchall())                             #displaying error
            ...
            messagebox.showerror("showerror","No field should be empty")
...
class ExamAdd:
    def __init__(self, top=None):
        ...
        self.duration_entry = tk.Entry(top, background="white", disabledforeground="#a3a3a3", font="TkFixedFont",
                                       foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                       insertbackground="black", selectbackground="blue", selectforeground="white", textvariable=time_format)
        ...
        self.date_entry = tk.Entry(top, background="white", disabledforeground="#a3a3a3", font="TkFixedFont",
                                   foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                   insertbackground="black", selectbackground="blue", selectforeground="white",textvariable=date_format)
        ...
        self.add_button = tk.Button(top, activebackground="#ececec", activeforeground="#000000", background="#E9ECEF",
                                    disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#d9d9d9",
                                    highlightcolor="black", pady="0", text='''Add''', command=lambda:self.select_add(self.exam_id_entry.get(), self.name_entry.get(), self.duration_entry.get(), self.date_entry.get(), self.tot_ques_entry.get(), self.tot_marks_entry.get(), self.branch_id_entry.get(), self.sub_code_entry.get()))
        self.add_button.place(relx=0.585, rely=0.854, height=24, width=87)
        
    def select_back(self):
        self.master.withdraw()
        
    def select_add(self, exam_id, exam_name, exam_duration, exam_date, exam_question, total_marks, branch_id, subject_code):
        if len(exam_id)!=0 and len(exam_name)!=0 and len(exam_duration)!=0 and len(exam_date)!=0 and len(exam_question)!=0 and len(total_marks)!=0 and len(branch_id)!=0 and len(subject_code)!=0:
            
            print("begin")
            sql_query = "INSERT INTO exam VALUES(" + exam_id + ", '" + exam_name + "', TIME('" + exam_duration + "'), STR_TO_DATE('" + exam_date + "', '%Y-%m-%d'), " + str(exam_question)  + ", " + str(total_marks) + ", " + str(branch_id) + ", '" + subject_code + "');"
            print("End")
            try:
                mycursor.execute(sql_query)                                     #executing query
                tv.insert(parent='', index='end', text="Parent", values=(exam_id, exam_name, exam_duration, exam_date, exam_question, total_marks, branch_id, subject_code))
                print("inside try : ",mycursor.fetchall())
            except (mysql.connector.Error, mysql.connector.Warning) as e:       #fetching error
                messagebox.showerror("showerror","ERROR MESSAGE :\n" + str(e)) 
                print("inside except : ",mycursor.fetchall())                             #displaying error
...
class ResultAdd:
    def __init__(self, top=None):
        ...
        self.add_button = tk.Button(top, activebackground="#ececec", activeforeground="#000000", background="#E9ECEF",
                                    disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#d9d9d9",
                                    highlightcolor="black", pady="0", text='''Add''', command=lambda:self.select_add(self.res_id_entry.get(), self.student_id_entry.get(), self.exam_id_entry.get(), self.marks_entry.get(), self.res_entry.get()))
        self.add_button.place(relx=0.585, rely=0.804, height=24, width=87)
    ...
    def select_add(self, result_id, student_id, exam_id, marks_obtained, result):
        if len(result_id)!=0 and len(student_id)!=0 and len(exam_id)!=0 and len(marks_obtained)!=0 and len(result)!=0:
            ...
            try:
                ...
                mycursor.execute(sql_query)                                     #executing query
                print("s1")
                tv.insert(parent='', index='end', text="Parent", values=(str(result_id), str(student_id), str(exam_id), str(marks_obtained), str(result)))
                print("s2")
                print("inside try : ",mycursor.fetchall())
            except (mysql.connector.Error, mysql.connector.Warning) as e:       #fetching error
                messagebox.showerror("showerror","ERROR MESSAGE :\n" + str(e)) 
...
class StudentAdd:
    def __init__(self, top=None):
        ...
        self.add_button = tk.Button(top, activebackground="#ececec", activeforeground="#000000",
                                    background="#E9ECEF", disabledforeground="#a3a3a3", foreground="#000000",
                                    highlightbackground="#d9d9d9", highlightcolor="black", pady="0", text='''Add''' , command= lambda :self.select_add(self.student_id_entry.get(),self.branch_id_entry.get(),self.roll_no_entry.get(),self.email_entry.get(),self.password_entry.get()))
        self.add_button.place(relx=0.585, rely=0.804, height=24, width=87)
    ...
    def select_add(self, student_id, branch_id, roll_no, email, password):
        if len(student_id)!=0 and len(roll_no)!=0 and len(password)!=0 and len(branch_id):
            ...
            try:
                mycursor.execute(sql_query)                                     #executing query
                tv.insert(parent='', index='end', text="Parent", values=(str(student_id), str(branch_id), str(roll_no), str(email), str(password)))
                print("inside try : ",mycursor.fetchall())
            except (mysql.connector.Error, mysql.connector.Warning) as e:       #fetching error
                messagebox.showerror("showerror","ERROR MESSAGE :\n" + str(e)) 
                print("inside except : ",mycursor.fetchall())                             #displaying error
...
class SubjectAdd:
    def __init__(self, top=None):
        ...
        self.add_button = tk.Button(top, activebackground="#ececec", activeforeground="#000000", background="#E9ECEF",
                                    disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#d9d9d9",
                                    highlightcolor="black", pady="0", text='''Add''', command=lambda:self.select_add(self.sub_code_entry.get(), self.branch_id_entry.get(), self.sub_name_entry.get(), self.sub_credit_entry.get()))
    ...
    def select_add(self, subject_code, branch_id, subject_name, subject_credit):
        if len(subject_code)!=0 and len(branch_id)!=0 and len(subject_name)!=0 and len(subject_credit)!=0:
            ...
            try:
                mycursor.execute(sql_query)                                     #executing query
                tv.insert(parent='', index='end', text="Parent", values=(subject_code, branch_id, subject_name, str(subject_credit)))
                print("inside try : ",mycursor.fetchall())
            except (mysql.connector.Error, mysql.connector.Warning) as e:       #fetching error
                messagebox.showerror("showerror","ERROR MESSAGE :\n" + str(e)) 
                print("inside except : ",mycursor.fetchall())                             #displaying error
...
class AttendanceModify:
    def __init__(self, top=None):
        ...
        self.modify_button = tk.Button(top, activebackground="#ececec", activeforeground="#000000",
                                       background="#E9ECEF", disabledforeground="#a3a3a3", foreground="#000000",
                                       highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
                                       text='''Modify''', command=lambda:self.select_modify(self.attendance_id_entry2.get(), self.student_id_entry2.get(), self.exam_id_entry2.get(), self.login_entry2.get(), self.logout_entry2.get()))
    ...
    def select_modify(self, attendance_id, student_id, exam_id, login_time, logout_time):
        try:
            sql_query = "UPDATE attendance SET attendance_id=" + str(attendance_id) + ", student_id=" + str(
                student_id) + ", exam_id=" + str(exam_id) + ", login_time=TIME('" + login_time + "'), logout_time=TIME('" + logout_time + "') WHERE attendance_id=" + str(item_modifyAttendance[0]) + ";"
            try:
                print(sql_query)
                mycursor.execute(sql_query)  # executing query
                print("s1")
                tv.item(tv.focus(), text="", values=(str(attendance_id), str(student_id), str(exam_id), login_time, logout_time))
                print("s2")
            except (mysql.connector.Error, mysql.connector.Warning) as e:  # fetching error
                messagebox.showerror("showerror","ERROR MESSAGE\n" + str(e))  # displaying error
...
class ExamModify:
    def __init__(self, top=None):
        ...
        self.modify_button = tk.Button(top, activebackground="#ececec", activeforeground="#000000",
                                       background="#E9ECEF", disabledforeground="#a3a3a3", foreground="#000000",
                                       highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
                                       text='''Modify''', command=lambda:self.select_modify(self.exam_entry2.get(), self.name_entry2.get(), self.duration_entry2.get(), self.date_entry2.get(), self.ques_entry2.get(), self.marks_entry2.get(), self.branch_entry2.get(), self.subject_entry2.get()))
    ...
    def select_modify(self, exam_id, exam_name, exam_duration, exam_date, total_questions, total_marks, branch_id, subject_code):
        try:
            sql_query = "UPDATE exam SET exam_id=" + str(exam_id) + ", exam_name='" + exam_name + "' , exam_duration=TIME('" + exam_duration + "'), exam_date=STR_TO_DATE('" + exam_date + "', '%Y-%m-%d'), total_questions=" + str(total_questions) + ", total_marks=" + str(total_marks) + ", branch_id=" + str(branch_id) + ", subject_code='" + subject_code + "' WHERE exam_id=" + str(item_modifyExam[0]) + ";"
            try:
                mycursor.execute(sql_query)  # executing query
                tv.item(tv.focus(), text="", values=( str(exam_id), exam_name, exam_duration, exam_date, str(total_questions), str(total_marks), str(branch_id), subject_code))
            except (mysql.connector.Error, mysql.connector.Warning) as e:  # fetching error
                messagebox.showerror("showerror","ERROR MESSAGE\n" + str(e))  # displaying error
        ...
        print("NEW : ",exam_id, exam_name, exam_duration, exam_date, total_questions, total_marks, branch_id, subject_code)
        mydb.commit()
        self.master.withdraw()
...
class ResultModify:
    def __init__(self, top=None):
        ...
        self.modify_button = tk.Button(top, activebackground="#ececec", activeforeground="#000000",
                                       background="#E9ECEF", disabledforeground="#a3a3a3", foreground="#000000",
                                       highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
                                       text='''Modify''',command=lambda:self.select_modify(self.res_id_entry2.get(), self.student_id_entry2.get(), self.exam_id_entry2.get(), self.marks_entry2.get(), self.res_entry2.get()))
        self.modify_button.place(relx=0.642, rely=0.907, height=24, width=77)
    ...
    def select_modify(self, result_id, student_id, exam_id, marks_obtained, result):
        try:
            sql_query = "UPDATE result SET result_id=" + str(result_id) + ", student_id=" + str(student_id) + ", exam_id=" + str(exam_id) + ", marks_obtained=" + str(marks_obtained) + ", result=" + str(result) + " WHERE result_id=" + str(item_modifyResult[0]) + ";"
            try:
                mycursor.execute(sql_query)  # executing query
                tv.item(tv.focus(), text="", values=(str(result_id), str(student_id), str(exam_id), str(marks_obtained), str(result)))
            except (mysql.connector.Error, mysql.connector.Warning) as e:  # fetching error
                messagebox.showerror("showerror","ERROR MESSAGE\n" + str(e))  # displaying error
...
class StudentModify:
    def __init__(self, top=None):
        ...
        self.modify_button = tk.Button(top, activebackground="#ececec", activeforeground="#000000",
                                       background="#E9ECEF", disabledforeground="#a3a3a3", foreground="#000000",
                                       highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
                                       text='''Modify''' , command=lambda:self.select_modify(self.student_id_entry2.get(), self.roll_no_entry2.get(), self.email_entry2.get(), self.password_entry2.get(), self.branch_id_entry2.get()))
        self.modify_button.place(relx=0.642, rely=0.907, height=24, width=77)
    ...
    def select_modify(self, student_id, roll_no, email, password, branch_id):
        try:
            ...
            sql_query = "UPDATE student SET student_id=" + str(student_id) + ", branch_id=" + str(
                    branch_id) + ", roll_no='" + roll_no + "', email='" + email + "', password='" + password + "' WHERE student_id=" + str(item_modifyStudent[0]) + ";"
            print("end")
            try:
                    mycursor.execute(sql_query)  # executing query
...
class SubjectModify:
    def __init__(self, top=None):
        ...
        self.modify_button.configure(activebackground="#ececec", activeforeground="#000000", background="#E9ECEF",
                        disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#d9d9d9",
                        highlightcolor="black", pady="0", text='''Modify''', command=lambda:self.select_modify(self.code_entry2.get(), self.branch_id_entry2.get(), self.name_entry2.get(), self.credit_entry2.get()))
    ...
    def select_modify(self, subject_code, branch_id, subject_name, subject_credit):
        try:
            sql_query = "UPDATE subject SET subject_code='" + subject_code + "' , branch_id=" + str(branch_id) + ", subject_name='" + subject_name + "', subject_credit=" + subject_credit + " WHERE subject_code='" + str(item_modifySubject[0]) + "';"
#            print(sql_query)
            try:
                mycursor.execute(sql_query)  # executing query
                tv.item(tv.focus(), text="", values=(subject_code, str(branch_id), subject_name, str(subject_credit)))
            except (mysql.connector.Error, mysql.connector.Warning) as e:  # fetching error
