...
def false_position(a,b):
	...
	for i in range(1000000):
		c = (a * calculate_value(b) - b * calculate_value(a))/(calculate_value(b) - calculate_value(a))
		
		if calculate_value(c)==0:
			return True,c
		elif calculate_value(c)*calculate_value(a)<0:
			b = c
		else:
			a = c
...
while True:
	...
	choice,answer = false_position(a, b)
	if choice:
